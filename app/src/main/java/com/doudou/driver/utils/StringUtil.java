...
public class StringUtil {
    ...
    public static String getHttpRequestTimestamp() {
     ...
     * @return
     */
    public static double doubleFormatD(double a) {
        DecimalFormat df = new DecimalFormat("#####0.00");
    ...
    public static Date strToDate(long time) {
        String strDate = String.valueOf(time);
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
...
//        String strDate = getHttpRequestTimestamp();
//
//        // 截取当前时间时分秒
...
//        if (strDateH >= strDateBeginH && strDateH < 24) {
...
//
//        System.out.println("result:" + isInDate("23:00", "05:00"));
////        System.out.println("result:" + ChineseName());
//
//    }
